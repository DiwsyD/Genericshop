...
////                        .ignoringRequestMatchers(PATH_VERSION + "/address/create")
//                                .disable()
//                )
                .csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(authorize -> authorize

                        .requestMatchers(PATH_VERSION + "/buildings")
                        .authenticated()

                        .requestMatchers(PATH_VERSION + PATH_ADDRESSES)
                        .hasAnyAuthority(Role.ADMIN.toString(), Role.USER.toString())

                        .requestMatchers(PATH_VERSION + "/building")
